    ...
    >
      <View style={styles.modalContainer}>
        <View style={styles.modalHeader}>
          <Text style={styles.header}>Saftey Tips</Text>
          <TouchableOpacity
        ...
        <View style={styles.modalContent}>
          <View style={styles.singleContainer}>
            ...
            <Text style={styles.singleContent}>
              Coordinate a meeting in-person at a public location to thoroughly
              inspect the equipment and bring a friend to accompany you.
            </Text>
          </View>
          <View style={styles.singleContainer}>
            <Text style={styles.bullett}>{'\u2022'}</Text>
            <Text style={styles.singleContent}>
              Never give out your private personal or financial information such
              as your medical records or banking information.
            </Text>
          </View>
          <View style={styles.singleContainer}>
            <Text style={styles.bullett}>{'\u2022'}</Text>
